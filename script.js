...
const projects = {
  proj1: { 
    ...
    type: "illustration", 
    images: [
      "img/client-logo(1).webp",
      "img/client-logo(4).webp",
      "img/client-logo(2).webp",
      "img/anim-baton(1).webp",
      "img/client-logo(4).webp"
    ] 
  },
  proj2: { 
    ...
    type: "animation", 
    images: [
      "img/client-illu(1).webp",
      "img/anim-baton(1).webp",
      "img/client-illu(2).webp"
    ] 
  },
  proj3: { 
    title: "PROJET 3", 
